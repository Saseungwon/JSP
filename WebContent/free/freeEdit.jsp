		...
		<div class="container">
			...
			<form action="freeModify.jsp" method="post">
				<table class="table table-striped table-bordered">
					...
					<tr>
						<th>글번호</th>
						<td>${free.boNo }<input type="hidden" name="boNo" value="${free.boNo }">
						</td>
					...
					<tr>
						<td colspan="2">
							...
							<div class="pull-right">
								...
								<a href="freeList.jsp" class="btn btn-info btn-sm"> <span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp;목록으로
								</a>
